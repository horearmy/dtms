...
export async function POST(req: NextRequest) {
  ...
  return runWithTenant(session.tenantId, async () => {
    ...
    await setSession({ id: updated.id, name: updated.name, username: updated.username, role: updated.role, tenantId: updated.tenantId, branchId: updated.branchId, pwdVersion: updated.pwdVersion });
