...
export default async function TrackingPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-brand-900 via-brand-700 to-brand-500 p-4">
      <div className="mb-6 text-center text-white">
        ...
        <p className="mt-1 text-sm text-brand-100">Lacak status pengiriman Anda dengan nomor resi</p>
      </div>
      ...
      <a href="/login" className="mt-8 text-xs text-brand-100 underline hover:text-white">Masuk untuk staf</a>
    </div>
  );
}