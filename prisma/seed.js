...
async function main() {
  ...
  const planData = [
    { name: 'Free', code: 'FREE', description: 'Coba gratis selamanya', priceMonthly: 0, priceYearly: 0, maxUsers: 3, maxDrivers: 5, maxShipments: 50, maxStorageMb: 50, maxBranches: 1, maxHubs: 0, maxOrganizations: 1, maxVehicles: 2, maxApiCallsPerMin: 0, trialDays: 0, features: ['basic_tracking', 'dispatch'], sortOrder: 0 },
    { name: 'Starter', code: 'STARTER', description: 'Untuk bisnis kecil', priceMonthly: 199000, priceYearly: 1990000, maxUsers: 5, maxDrivers: 15, maxShipments: 500, maxStorageMb: 500, maxBranches: 2, maxHubs: 2, maxOrganizations: 1, maxVehicles: 5, maxApiCallsPerMin: 60, trialDays: 14, features: ['basic_tracking', 'dispatch', 'reports', 'gps_tracking'], sortOrder: 1 },
    { name: 'Growth', code: 'GROWTH', description: 'Untuk logistik menengah', priceMonthly: 449000, priceYearly: 4290000, maxUsers: 15, maxDrivers: 40, maxShipments: 2000, maxStorageMb: 2048, maxBranches: 10, maxHubs: 10, maxOrganizations: 3, maxVehicles: 15, maxApiCallsPerMin: 120, trialDays: 14, features: ['basic_tracking', 'dispatch', 'reports', 'gps_tracking', 'warehouse_management', 'geofencing', 'branch_management'], sortOrder: 2 },
    { name: 'Professional', code: 'PRO', description: 'Untuk tim operasional', priceMonthly: 899000, priceYearly: 8630000, maxUsers: 50, maxDrivers: 150, maxShipments: 10000, maxStorageMb: 5120, maxBranches: -1, maxHubs: -1, maxOrganizations: -1, maxVehicles: 60, maxApiCallsPerMin: 600, trialDays: 30, features: ['basic_tracking', 'dispatch', 'reports', 'gps_tracking', 'warehouse_management', 'geofencing', 'branch_management', 'sla', 'eta', 'control_tower', 'api', 'webhooks', 'daily_reports'], sortOrder: 3 },
    { name: 'Enterprise', code: 'ENTERPRISE', description: 'Untuk perusahaan besar', priceMonthly: 2499000, priceYearly: 24490000, maxUsers: -1, maxDrivers: -1, maxShipments: -1, maxStorageMb: 20480, maxBranches: -1, maxHubs: -1, maxOrganizations: -1, maxVehicles: -1, maxApiCallsPerMin: -1, trialDays: 30, features: ['basic_tracking', 'dispatch', 'reports', 'gps_tracking', 'warehouse_management', 'geofencing', 'branch_management', 'sla', 'eta', 'control_tower', 'api', 'webhooks', 'daily_reports', 'analytics_advanced', 'integrations', 'whatsapp_integration', 'white_label', 'priority_support'], sortOrder: 4 },
  ];
