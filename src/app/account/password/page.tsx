    ...
    <div className="w-full max-w-md">
      <div className="rounded-2xl bg-white p-8 shadow-lg">
        <div className="mb-6 text-center">
          <div className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-600 text-2xl font-bold text-white">DT</div>
          ...
          {first ? (
            ...
            <p className="mt-1 text-sm text-gray-500">Perbarui password akun Anda</p>
          )}
        </div>
        ...
        <div className="mt-4 text-center">
          <Link href="/driver" onClick={(e) => { e.preventDefault(); router.push(first ? '/login' : '/dashboard'); }} className="text-xs font-semibold text-brand-600 underline">
